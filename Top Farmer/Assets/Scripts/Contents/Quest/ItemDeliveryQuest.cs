...
public class ItemDeliveryQuest : Quest
{
    ...
    string questStringId = "ItemDeliveryQuest";
    ...
    public ItemDeliveryQuest()
    {
        ...
        switch (randDescriptionIndex)
        {
            ...
            case 2:
                {
                    TargetItemId = Random.Range(301, 324);
                    TargetQuantity = 1;
                    QuestDescription = string.Format(CombineQuestDescription(randDescriptionIndex), itemName);
                }
                break;
        ...
        QuestObjective = string.Format("{0}에게 {1} 배달하기.", TargetName, itemName);
        NextQuest = -1;
        ItemReward = -1;
            ...
            case 0:
                {
                    ...
                    string str1 = Managers.Data.StringDict[questStringId + index1.ToString()].ko;
                    string str2 = Managers.Data.StringDict[questStringId + index2.ToString()].ko;
                    string str3 = Managers.Data.StringDict[questStringId + index3.ToString()].ko;
    ...
    string GetReactionText()
    {
        ...
        string reactionText = Managers.Data.StringDict[questStringId + reactionIndex.ToString()].ko;
